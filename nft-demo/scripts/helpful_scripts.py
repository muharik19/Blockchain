...
def get_contract(contract_name):
    ...
    This function will either:
        ...
        - Or deploy a Mock to use for a netwotk that doesn't have the contract

    Args:
        contract_name (string): This is the name of the contract that we will get from the config or deploy

    Returns:
        brownie.network.contract.ProjectContract: This is the most recently deployed contract of the type specified by a dictionary.
        This could either be a mock or a 'real' contract on live network.
    """
    # link_token
    # LinkToken
